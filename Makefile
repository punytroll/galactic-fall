...
arx_reading.o: arx_reading.cpp $(arx_reading_h) $(arxx_resources_h) $(buffer_reading_h) $(label_h) $(model_h) $(model_manager_h) $(ship_class_h) $(ship_class_manager_h) $(user_interface_h) $(widget_h)
