	...
	_MessageLabel(nullptr)
{
	...
	MiniMapSystemNameLabel->SetWidth(MiniMapWidget->GetWidth());
	...
	MiniMapBorder->SetWidth(MiniMapWidget->GetWidth());
	...
	ScannerTargetNameLabel->SetWidth(ScannerWidget->GetWidth());
	...
	ScannerBorder->SetWidth(ScannerWidget->GetWidth());
