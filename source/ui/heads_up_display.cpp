	...
	_MessageLabel(nullptr)
{
	...
	MiniMapWidget->SetLeft(GetSize()[0] - MiniMapWidget->GetSize()[0]);
	MiniMapWidget->SetTop(GetSize()[1] - MiniMapWidget->GetSize()[1]);
	...
	MiniMapDisplay->SetSize(Vector2f(MiniMapWidget->GetSize()[0], MiniMapWidget->GetSize()[1] - MiniMapDisplay->GetTop()));
	...
	ScannerWidget->SetTop(GetSize()[1] - ScannerWidget->GetSize()[1]);
